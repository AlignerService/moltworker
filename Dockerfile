...
# NOTE: Keep everything on ONE RUN line (or use backslashes) to avoid dockerfile parse errors.
RUN npm install -g --loglevel=verbose clawdbot@2026.1.24-3 && clawdbot --version
